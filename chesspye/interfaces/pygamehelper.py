'''
    Originally by Andrej Karpathy (http://cs.stanford.edu/people/karpathy/).
    From his pygame tutorials -  http://karpathy.ca/phyces/tutorial1.php
    'Bout time I cite this. 
'''
